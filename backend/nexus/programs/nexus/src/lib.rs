...
pub mod nexus {
    ...
    pub fn initialize(ctx: Context<Initialize>, _name : String, _email : String, _password : String, _date : ) -> Result<()> {
    ...
    pub fn create_event(ctx: Context<CreateEvent>, _id : u8, _name: String, _tickets_available: u32, _ticket_price: u64, _location: String, _events: &mut Vec<Event>, _category : &mut Vec<String>, _starting date : String, _ending_date : String, _event_type : String) -> ProgramResult {
    ...
    pub start_event(ctx :Context<StartEvent>, _event_id : u8) -> Result<()> {
        let event = &mut ctx.accounts.event_account;
        require!(
